...
df_postgres <- dbGetQuery(con, "SELECT finales_adeudados,cursadas_adeudadas,optativas_adeudadas,adeuda_trab_final_inicio,plan,tutor_r1, recibido_fin_r1 from revalidas WHERE usable=TRUE")
